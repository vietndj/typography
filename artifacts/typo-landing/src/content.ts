  ...
  bonuses: [
    {
      ...
      desc: "Danh sách các xưởng chữ hàng đầu (Grilli Type, cotypefoundry...) kèm file Font Trial để bạn thực hành chuẩn quy trình Agency. [ Các font này đều đã được việt hóa, xử lý dấu chi tiết tương thích với cấu tạo font ]",
    },
    {
      icon: "📋",
